                ...
                <Styled.Wrapper>
                    <Styled.Box>
                        <Styled.BoxDataWrapper>
                            <Styled.RoleTitle>{titles[0].title}</Styled.RoleTitle>
                    ...
                    <Styled.Box>
                        <Styled.RoleTitle>{titles[1].title}</Styled.RoleTitle>
                    ...
                    <Styled.Box>
                        <Styled.RoleTitle>{titles[2].title}</Styled.RoleTitle>
                    ...
                    <Styled.Box>
                        <Styled.RoleTitle>{titles[3].title}</Styled.RoleTitle>
                    ...
                    <Styled.Box>
                        <Styled.RoleTitle>{titles[4].title}</Styled.RoleTitle>
